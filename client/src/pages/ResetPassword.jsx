    ...
    >
      ...
      {!isEmailSent && (
        ...
        >
          ...
          <p className="text-center mb-6 text-indigo-300">
            Enter the your ragistered email address
          </p>
          ...
          <button
            className="w-full py-2.5  bg-gradient-to-t from-indigo-500 to bg-indigo-900
      ...
      {!isOtpSubmited && isEmailSent && (
        ...
        >
          ...
          <button className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900  text-while rounded-full">
            Submit
          </button>
        </form>
      )}
